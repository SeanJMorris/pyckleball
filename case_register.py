...
def case_register(case_day_input: datetime,
    ...
    with Timer() as timer:
        ...
        # is_registered = expect(page.get_by_role("row", name="Mobley Hesperweld (4.0)").get_by_role("img")).to_be_visible(timeout=3000)
        is_registered = expect(page.get_by_text("Mobley Hesperweld (4.0)")).to_be_visible()
